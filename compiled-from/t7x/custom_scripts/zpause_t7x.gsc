/*
======================================================================
    ZPAUSE T7 (T7x) v1.4  --  Synced co-op pause for Black Ops III Zombies
...
*/
function zp_pause_hint_text( player )
{
...
function zp_down_hint_text( kind )
{
...
*/
function zp_vote_hint_text( player, binds )
{
